...
export default function Register() {
  return (
    <section className="min-h-screen bg-deepBlack flex justify-center items-center px-6 text-white">
      ...
      >
        <h1 className="text-3xl font-serif text-amberGold text-center">Join ScentsWorld</h1>

        <input type="text" placeholder="Full Name" className="w-full p-3 bg-white/5 border border-white/10 rounded-xl outline-none" />
        ...
        <p className="text-center text-sm text-white/50">
          ...
          <Link href="/login" className="text-amberGold hover:underline">Login</Link>
        </p>
      </motion.div>
    </section>
  );
